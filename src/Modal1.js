...
define(['jquery','underscore','backbone'], function($,_,Backbone) {
    ...
    var ModalController, Modal, modalController, SPINNER = null, SPEED = 300;
    ...
    Modal = Backbone.View.extend({
        ...
        initialize: function(){
            ...
            this.options = _.extend({}, obj.Modal.defaultSettings, this.options||{});
...
var obj={};
    obj.Modal = function(opts){ return new Modal(opts) }
    obj.Modal.close = function(opts){ modalController.closeAll() }

    obj.Modal.defaultSettings = defaultSettings;

    /*
     Spinner
     */
    obj.Modal.spinner = function(msg){
    ...
    /*
     Alert
     */
    obj.Modal.alert = function(title, msg){

        var args = defaultArgs(arguments, null, null);

        if( args ) return obj.Modal.alert.apply(this, args);
    ...
    /*
     Alert
     */
    obj.Modal.success = function(title, msg){

        var args = defaultArgs(arguments, null, null);

        if( args ) return obj.Modal.success.apply(this, args);
    ...
    /*
     Alert
     */
    obj.Modal.error = function(title, msg){

        var args = defaultArgs(arguments, null, null);

        if( args ) return obj.Modal.error.apply(this, args);
    ...
    /*
     Confirm
     */
    obj.Modal.confirm = function(title, msg, callback){

        var args = defaultArgs(arguments, null, null, null);

        if( args ) return obj.Modal.confirm.apply(this, args);
    ...
    /*
     Confirm Delete
     */
    obj.Modal.confirmDelete = function(title, msg, callback){

        var args = defaultArgs(arguments, null, null, null);

        if( args ) return obj.Modal.confirmDelete.apply(this, args);
    ...
    /*
     Prompt
     */
    obj.Modal.prompt = function(title, msg, opts, callback){
        ...
        if( args ) return obj.Modal.prompt.apply(this, args);
